...
namespace CaptainCoder.Dungeoneering.Unity
{
    ...
    public class PlayerViewController : MonoBehaviour
    {
        ...
        public void HandleInput(MovementAction action)
        {
            ...
            PlayerView.View = PlayerControls.Move(_dungeonCrawlerData.DungeonData.Dungeon, PlayerView.View, action);
        }
        ...
        private void HandleInputIgnoringWalls(MovementAction action)
        {
            ...
            PlayerView newView = action switch
            {
                ...
                _ => PlayerControls.Move(_dungeonCrawlerData.DungeonData.Dungeon, PlayerView.View, action),
            };
